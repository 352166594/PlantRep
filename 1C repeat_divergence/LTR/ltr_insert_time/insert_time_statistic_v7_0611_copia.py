...
dir_out = "/vol3/agis/huangsanwen_group/luoxizhi/work/525_harvast/copia_mya2_insert_time/"
...
out_name =species_whole_name+"_copia_ltr_inserttime.xls"
f2=open(out_name,"w")
...
for line1 in f1:
	...
	if "Copia" not in list1[-3]:continue
