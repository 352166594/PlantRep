...
#					fout2.write("{0}\t{1}\t{2}\t{3}\n".format(species_type,dive,dict_kindom[type][repeat][dive]))
					fout2.write("{0}\t{1}\t{2}\t{3}\n".format(type,repeat,dive,  round(dict_kindom[type][repeat][dive]/float(dict_number[type][repeat][dive]),4) ))
				else:
					fout2.write("{0}\t{1}\t{2}\t{3}\n".format(type,repeat,dive,0))
		else:	
			for dive in div_list:
				fout2.write("{0}\t{1}\t{2}\t{3}\n".format(type,repeat,dive,0))
