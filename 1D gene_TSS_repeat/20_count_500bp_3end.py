...
#			sit = title.split("\t")[i]
#			print sit
			sites = sit.split("bp")[0].split("-")[1]	#0-1kb
			whole_sites = (int(sites)*2)/1000+60		#61
			#f2.write(te+"\t"+str(whole_sites)+"\t"+str(TE_type[te][sit])+"\t"+"500bp_3end\n")
			if  sit in TE_type[te]:
				f2.write(te+"\t"+str(whole_sites)+"\t"+str(TE_type[te][sit])+"\t"+sit+"\t"+"500bp_3end\n")
			else:
				f2.write(te+"\t"+str(whole_sites)+"\t"+str(0)+"\t"+sit+"\t"+"500bp_3end\n")
