...
f1 = open('super_family_length.xls')
f2 = open('super_family_length_percentage_repeat.xls','w')
f3 = open('super_family_length_number_genome.xls','w')
f4 = open('super_family_length_percentage_genome.xls','w')
